              ...
              fluidRow(
                ...
                column(5, offset = 0,
                    ...
                    contains the string 'Sample'."),
                         h5("2. Ensure all non-row header cell values are numeric. This 
              ...
              sidebarLayout(
                ...
                mainPanel(
                  tabsetPanel(      
                    ...
                    ### Panel tab that lets users view and average specific data.
                    ### For instance, if you have 3 replicates of Samples A, B,
                    ### and C, you can input A, B, and C, to see all of them in 
                    ### a single table, as well as averaged.
                    tabPanel("Averages",
                             wellPanel(
